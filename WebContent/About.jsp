...
<table  border="0" align="center"  bgcolor="white" width="80%">              <tr>
                 <td height="300" align="right"></td>
                 <td>
 
         
      <h4>  <p>This File Sharing System concerns with the development of a system 
        that is simple and easy to use yet a powerful web application for sharing,
         managing and controlling enterprise Files like images ,
        videos audios and documents on intranet/internet in a secure manner.
     </p><p>    
	Manage your Files over the Web. 
	It enables to create a central repository of organizational our Folders 
	with in this folders we can create our own folders and we can upload our files. 
	File Sharing System provides a file management with secure access control,
	 sharing and supporting File with in the registered users. 

        </p>
  </h4> 
		</td></tr></table>																<p class="just">
