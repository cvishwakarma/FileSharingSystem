...
<table  border="0" align="center"  bgcolor="white" width="80%">      
      ...
      <center><span class=Title><h3>Report ByDate Form </h3></span></center>
    <% if(request.getParameter("status")!=null)
					  {%>
                           <strong><%=request.getParameter("status")%></strong>
                      <%}%>
      
		<form id="form3" name="ViewAllUser" method="post"
			action="ViewAllRegisterUsersByDate.jsp">
			<table border="0" align="center">
				<tr>
    <td><span class=Title> From Date</span></td>
    <td>
   <input type="text" name="fromdate" value="" size="20" readonly="readonly" /><a href="javascript:show_calendar('document.ViewAllUser.fromdate', document.ViewAllUser.fromdate.value);"> <img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a>  </td>
  </tr>
  		<tr>
    <td><span class=Title> To Date</span></td>
    <td>
   <input type="text" name="todate" value="" size="20" readonly="readonly" /><a href="javascript:show_calendar('document.ViewAllUser.todate', document.ViewAllUser.todate.value);"> <img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a> </td>
  </tr>
  
				<tr>
					<td colspan="2">
						<div align="center"><strong>
						  <input type="submit" name="Submit" value="GetDetails" onClick="doDateCheck(this.form.fromdate, this.form.todate);"/>
						</strong></div>				  </td>
				</tr>
			</table>
		</form>
