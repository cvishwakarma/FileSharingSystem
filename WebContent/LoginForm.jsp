...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<p>&nbsp;</p>
          ...
          <form action="./LoginAction" method="post" name="register" onSubmit="return valdatelogin()">
      ...
      <center>  <% if(request.getParameter("status")!=null)
        ...
        <table  border="0" align="center"  bgcolor="white" width="80%">
               ...
               <tr>
                 <td >&nbsp;</td>
                 <td>
                 <div align="center"><a href="Recoverpassword.jsp"><strong><font color="#000000">Forgot Password ! !......</font></strong></a></div></td>
                 <td>&nbsp;</td>
               </tr>
               <tr>
                 <td >&nbsp;</td>
                 <td>
                 <div align="center"><a href="Registerform.jsp"><strong><font color="#000000">New User....?</font></strong></a></div></td>
                 <td>&nbsp;</td>
               </tr>
           </table>
          </form>
