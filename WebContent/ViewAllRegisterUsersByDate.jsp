...
<%@page import="com.dts.core.util.DateWrapper,java.util.*"%>
...
<table border="1" align="center" bordercolor="#000000" bgcolor="#66CCFF" width="719" height="20%">
  ...
  <tr><strong><span class="style16">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RegisteredUsers Report Details From <%=sdate %> to <%=edate %><br/>
            <br/>
  </span></strong></tr>
  <tr>
    
    <td bgcolor="#E0FEFD"><div align="center" class="style16">LoginID</div></td>
    <td bgcolor="#E0FEFD"><div align="center" class="style16">Name</div></td>
  ...
  <%int sno=1;
		   ...
		   CoreHash aCoreHash=new ProfileDAO().getReportByRegisterDate(sdate,edate);
 ...
 <tr>
    ...
    <td bgcolor="#EFFEFF"><div align="center" class="style16"><%=aProfile.getFirstName() %> <%=aProfile.getLastName() %></div></td>
...
<p> <span class="style16">Report Generated on <strong><%=DateWrapper.parseDate(new Date()) %></strong> &nbsp;&nbsp;&nbsp;&nbsp; generated By <strong><%=session.getAttribute("user") %>(<%=session.getAttribute("role") %>)</strong><br/><br></p>
		<p class="just">
